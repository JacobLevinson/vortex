...
`define VX_DCR_BASE_SPATIAL_ADDR_START  12'h006
`define VX_DCR_BASE_SPATIAL_ADDR_END    12'h007
`define VX_DCR_BASE_SPATIAL_X_MASK      12'h008
`define VX_DCR_BASE_SPATIAL_Y_MASK      12'h009
`define VX_DCR_BASE_SPATIAL_Z_MASK      12'h00A
`define VX_DCR_BASE_SPATIAL_X_SHIFT     12'h00B
`define VX_DCR_BASE_SPATIAL_Y_SHIFT     12'h00C
`define VX_DCR_BASE_SPATIAL_Z_SHIFT     12'h00D
